...
ROLES = {
    "finance": {
        ...
        "allowed_tools": ["log_expense", "log_income", "get_financial_summary", "search_transactions", "delete_transaction", "currency_converter", "crypto_tracker", "calculate", "get_stock_price", "get_nse_stock_price", "update_mmf_balance", "update_stock_shares", "get_investment_portfolio", "analyze_market_opportunities"]
    },
    "research": {
